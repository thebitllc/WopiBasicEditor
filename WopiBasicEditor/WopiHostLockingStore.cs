// <copyright file="WopiHostLockingStore.cs" company="Bit, LLC">
...
{
    public class WopiHostLockingStore : HostLockingStore
    {
        private WopiSession _session;

        public WopiHostLockingStore(WopiSession session)
            : base()
        {
            _session = session;
        }
        ...
        public override WhoAmIRequest.OutputType HandleWhoAmI(WhoAmIRequest.InputType input)
        {
            ...
            result.UserEmailAddress = _session.Email;
            result.UserIsAnonymous = _session.IsAnonymous;
            result.UserLogin = _session.Login;
            result.UserName = _session.Name;
